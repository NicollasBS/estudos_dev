...
$stmt = $pdo->prepare('SELECT id, url, titulo FROM videos WHERE id = ?');
$stmt->bindValue(1, $id);
...
<body>
    ...
    <main class="container">
        ...
        <form class="container__formulario" method="post" action="/editor-video.php">
